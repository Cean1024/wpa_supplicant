...
//   David, 2006.9.26
#define IPW_PARAM_WPAX_SELECT			7

#define IPW_PROTO_WPA				1	
#define IPW_PROTO_RSN				2
//Added for notify the encryption type selection
//   David, 2006.9.26
#define IPW_WPAX_USEGROUP			0
#define IPW_WPAX_WEP40				1
#define IPW_WPAX_TKIP				2
#define IPW_WPAX_WRAP   			3
#define IPW_WPAX_CCMP				4
#define IPW_WPAX_WEP104				5

#define IPW_KEY_MGMT_IEEE8021X			1
#define IPW_KEY_MGMT_PSK			2
