				   ...
				   u8 *mk, u8 *ck, u8 *ick)
{
	...
	eap_pax_kdf(mac_id, ak, EAP_PAX_AK_LEN, "Master Key",
		    e, 2 * EAP_PAX_RAND_LEN, EAP_PAX_MK_LEN, mk);
	eap_pax_kdf(mac_id, ak, EAP_PAX_AK_LEN, "Confirmation Key",
		    e, 2 * EAP_PAX_RAND_LEN, EAP_PAX_CK_LEN, ck);
	eap_pax_kdf(mac_id, ak, EAP_PAX_AK_LEN, "Integrity Check Key",
