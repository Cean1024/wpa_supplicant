...
struct wpa_scan_result {
	...
	size_t rsn_ie_len;
	int freq; /* MHz */
	u16 caps; /* capability field from beacon/proberesp; e.g. privacy;
		   * in host byte order */
...
struct wpa_driver_associate_params {
	/* BSSID of the selected AP. This can be %NULL, if ap_scan=2 mode is
	 * used and the driver is responsible for selecting with which BSS to
	 * associate. */
	const u8 *bssid;
