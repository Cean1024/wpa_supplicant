...
/* IN: 16-octet peer_challenge, 16-octet auth_challenge, 0..256-char username
...
/* IN: 0..256-unicode-char password
 * OUT: 16-octet password_hash */
...
/* IN: 16-octet password_hash
 * OUT: 16-octet password_hash_hash */
...
/* IN: 8-octet challenge, 16-octet password_hash
...
/* IN: 16-octet auth_challenge, 16-octet peer_challenge, 0..256-char username,
 *     0..256-unicode-char password
 * OUT: 24-octet response */
...
/* IN: 0..256-unicode-char password, 24-octet nt_response,
 *     16-octet peer_challenge, 16-octer auth_challenge, 0..256-char username
 * OUT: 42-octet response */
...
/* IN: 8-octet challege, 0..256-unicode-char password
 * OUT: 25-octet response */
...
/* IN: 16-octet master_key
 * IN: session_key_len, is_send, is_server
 * OUT: session_key (8..16 octets) */
...
/* IN: 0..256-unicode-char password, 16-octet password_hash
 * OUT: 516-byte pw_block */
...
/* NewPasswordEncryptedWithOldNtPasswordHash() routine defined in [RFC2759],
 * Section 8.9.
 * IN: 0..256-unicode-char new_password,
 *     0..256-unicode-char old_password
 * OUT: 516-octet encrypted_pw_block
 */
...
/* IN: 16-octer password_hash, 16-octet block
 * OUT: 16-octer cypher */
 ...
 * IN: 0..256-unicode-char new_password,
 *     0..256-unicode-char old_password
 * OUT: 16-octet encrypted_password_hash
 */
